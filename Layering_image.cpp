...
int main(int argc, char* argv[]) {
    ...
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/layer18.jpeg"));                 // Index 0: sky
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/layer19.png")); // Index 1: inner building 
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/layer20.png")); // Index 2: outer building
